...
#show: wsjrdp2027_letter.with(
    body-size: 10pt,
    title-text: [Bestätigung der Abmeldung – World Scout Jamboree 2027],
    footer-text: [Bestätigung der Abmeldung],
    role-id-name: role_id_name,
)

Hiermit bestätigen wir die Abmeldung
beim Ring deutscher Pfadfinder*innenverbände e.V. (rdp),
Chausseestraße 128/129, 10115 Berlin vom Vertrag zur Teilnahme im
...
#box(height: form_line_height)#person_id_line(hitobitoid: hitobitoid, issue: deregistration_issue, ticket-type: "Abmeldung")
